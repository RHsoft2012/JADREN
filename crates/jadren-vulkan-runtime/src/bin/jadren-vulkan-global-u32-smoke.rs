use jadren_vulkan_runtime::run_global_u32_queue_smoke;

fn main() {
    match run_global_u32_queue_smoke() {
        Ok(report) => {
            println!(
                "schema={} devices={} device={} queue_family={} queue={} descriptor={} resources={} pipeline={} fence={} data={} differential={} residency={} elements={} input_checksum={} output_checksum={} expected_checksum={} first={} last={}",
                report.schema,
