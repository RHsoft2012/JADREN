...
fn main() {
    match run_global_dynamic_u32_queue_smoke() {
        Ok(report) => {
            println!(
                "schema={} devices={} device={} queue_family={} queue={} descriptor={} resources={} pipeline={} fence={} data={} differential={} residency={} elements={} capacity={} dispatch_x={} runtime_length={} input_checksum={} output_checksum={} expected_checksum={} first={} last={} untouched_tail={}",
                report.schema,
