...
/// `1=type`, `2=function`, `3=block`, `4=instruction`, or `5=terminator`.
...
mod tests {
    ...
    use super::{
        ...
        Stage2JirRecord, Stage2JirSummary, TOKEN_INFO_API_VERSION, TokenCounts, TokenInfo,
        TokenSpan, TypedCallBindingHeader, TypedCallCandidateHeader, TypedExpressionHeader,
